(function (root) {
  ...
  Game.prototype.bindKeyHandlers = function () {
    ...
    window.key('w', that.ship.power.bind(that.ship, [0, -2]));
    window.key('s', that.ship.power.bind(that.ship,[0, 2]));
    window.key('a', that.ship.power.bind(that.ship,[-2, 0]));
    window.key('d', that.ship.power.bind(that.ship,[2, 0]));
